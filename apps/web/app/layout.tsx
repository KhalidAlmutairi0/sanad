...
// IBM Plex Sans Arabic + Mono (the sanadscreen design). Self-hosted at build by next/font
// (no runtime CDN calls — sovereignty-safe). Var names kept so tokens/tailwind resolve.
